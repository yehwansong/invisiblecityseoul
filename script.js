...
document.addEventListener('touchstart', function(e) {
          ...
          mousexafter = e.touches[0].clientX;
          mouseyafter = e.touches[0].clientY;

        if(mousex<window.innerWidth*(4/5) || mousey>window.innerWidth/10){
        ...
        $( ".smartbox" ).each(function( index ) {
                ...
                if(!$( this ).hasClass('selected')){
                  if($( this ).hasClass('group1')){
                    $( this ).animate({left: thisleft-arr[0]*unit, top: thistop-arr[0]*unit },80);
                  }
                  if($( this ).hasClass('group2')){
                    $( this ).animate({left: thisleft-arr[1]*unit, top: thistop-arr[1]*unit },80);
                  }
                  if($( this ).hasClass('group3')){
                    $( this ).animate({left: thisleft-arr[2]*unit, top: thistop-arr[2]*unit },80);
                  }
                  if($( this ).hasClass('group4')){
                    $( this ).animate({left: thisleft-arr[3]*unit, top: thistop-arr[3]*unit },80);
                  }
                  if($( this ).hasClass('group5')){
                    $( this ).animate({left: thisleft-arr[4]*unit, top: thistop-arr[4]*unit },80);
                  }
                  if($( this ).hasClass('group6')){
                    $( this ).animate({left: thisleft-arr[5]*unit, top: thistop-arr[5]*unit },80);
                  }
                }
        });
      }
        ...
        $( ".smartbox" ).each(function( index ) {
                if(!$( this ).hasClass('.selected')){
                  ...
                  if(!$( this ).hasClass('down')){
                    if(($( this ).hasClass('vrow1') && offset.left>0.018*w-1.5*unit) || 
                       ($( this ).hasClass('vrow2') && offset.left>0.17867*w-1.5*unit) || 
                       ($( this ).hasClass('vrow3') && offset.left>0.33934*w-1.5*unit) ||  
                       ($( this ).hasClass('vrow4') && offset.left>0.5*w-1.5*unit) || 
                       ($( this ).hasClass('vrow5') && offset.left>0.66067*w-1.5*unit) || 
                       ($( this ).hasClass('vrow6') && offset.left>0.82134*w-1.5*unit)){
                        $( this ).css( "left",'-='+diff);
                        $( this ).css( "top",'-='+diff);
                      }else{
                    $( this ).addClass("down")
                  ...
                  if($( this ).hasClass('down')){
                    if(($( this ).hasClass('vrow1') && offset.left<0.018*w) || 
                       ($( this ).hasClass('vrow2') && offset.left<0.17867*w) || 
                       ($( this ).hasClass('vrow3') && offset.left<0.33934*w) ||  
                       ($( this ).hasClass('vrow4') && offset.left<0.5*w) || 
                       ($( this ).hasClass('vrow5') && offset.left<0.66067*w) || 
                       ($( this ).hasClass('vrow6') && offset.left<0.82134*w)){
                          $( this ).css( "left",'+='+diff);
                          $( this ).css( "top",'+='+diff);
                        }else{
...
////아래추가
      ...
      document.addEventListener('touchend', function() {
            $('.smartbox_surface').animate({opacity: 1}, {duration:80, queue: false});
                        // jQuery.easing.def = 'easeOutBounce';
          $( "#smartbox1" ).animate({left: 0.018*w+0.038*w, top: 0.16067*w+0.038*w},{ duration: 250, queue: false });
          $( "#smartbox11" ).animate({left: 0.018*w+0.030*w, top: 0.32134*w+0.030*w},{ duration: 250, queue: false });
          $( "#smartbox21" ).animate({left: 0.018*w+0.018*w, top: 0.48201*w+0.018*w},{ duration: 250, queue: false });
          $( "#smartbox31" ).animate({left: 0.018*w+0.030*w, top: 0.64268*w+0.030*w},{ duration: 250, queue: false });
          $( "#smartbox41" ).animate({left: 0.018*w+0.018*w, top: 0.80335*w+0.018*w},{ duration: 250, queue: false });
          $( "#smartbox51" ).animate({left: 0.018*w+0.028*w, top: 0.96402*w+0.028*w},{ duration: 250, queue: false });

          $( "#smartbox2" ).animate({left: 0.17867*w+0.018*w, top: 0.16067*w+0.018*w},{ duration: 250, queue: false });
          $( "#smartbox12" ).animate({left: 0.17867*w+0.03*w, top: 0.32134*w+0.03*w},{ duration: 250, queue: false });
          $( "#smartbox22" ).animate({left: 0.17867*w+0.018*w, top: 0.48201*w+0.018*w},{ duration: 250, queue: false });
          $( "#smartbox32" ).animate({left: 0.17867*w+0.02*w, top: 0.64268*w+0.02*w},{ duration: 250, queue: false });
          $( "#smartbox42" ).animate({left: 0.17867*w+0.038*w, top: 0.80335*w+0.038*w},{ duration: 250, queue: false });
          $( "#smartbox52" ).animate({left: 0.17867*w+0.018*w, top: 0.96402*w+0.018*w},{ duration: 250, queue: false });

          $( "#smartbox3" ).animate({left: 0.33934*w+0.018*w, top: 0.16067*w+0.018*w},{ duration: 250, queue: false });
          $( "#smartbox13" ).animate({left: 0.33934*w+0.018*w, top: 0.32134*w+0.018*w},{ duration: 250, queue: false });
          $( "#smartbox23" ).animate({left: 0.33934*w+0.023*w, top: 0.48201*w+0.023*w},{ duration: 250, queue: false });
          $( "#smartbox33" ).animate({left: 0.33934*w+0.018*w, top: 0.64268*w+0.018*w},{ duration: 250, queue: false });
          $( "#smartbox43" ).animate({left: 0.33934*w+0.012*w, top: 0.80335*w+0.012*w},{ duration: 250, queue: false });
          $( "#smartbox53" ).animate({left: 0.33934*w+0.018*w, top: 0.96402*w+0.018*w},{ duration: 250, queue: false });

          $( "#smartbox4" ).animate({left: 0.5*w+0.018*w, top: 0.16067*w+0.018*w},{ duration: 250, queue: false });
          $( "#smartbox14" ).animate({left: 0.5*w+0.023*w, top: 0.32134*w+0.023*w},{ duration: 250, queue: false });
          $( "#smartbox24" ).animate({left: 0.5*w+0.018*w, top: 0.48201*w+0.018*w},{ duration: 250, queue: false });
          $( "#smartbox34" ).animate({left: 0.5*w+0.012*w, top: 0.64268*w+0.012*w},{ duration: 250, queue: false });
          $( "#smartbox44" ).animate({left: 0.5*w+0.038*w, top: 0.80335*w+0.038*w},{ duration: 250, queue: false });
          $( "#smartbox54" ).animate({left: 0.5*w+0.018*w, top: 0.96402*w+0.018*w},{ duration: 250, queue: false });

          $( "#smartbox5" ).animate({left: 0.66067*w+0.018*w, top: 0.16067*w+0.018*w},{ duration: 250, queue: false });
          $( "#smartbox15" ).animate({left: 0.66067*w+0.018*w, top: 0.32134*w+0.018*w},{ duration: 250, queue: false });
          $( "#smartbox25" ).animate({left: 0.66067*w+0.023*w, top: 0.48201*w+0.023*w},{ duration: 250, queue: false });
          $( "#smartbox35" ).animate({left: 0.66067*w+0.018*w, top: 0.64268*w+0.018*w},{ duration: 250, queue: false });
          $( "#smartbox45" ).animate({left: 0.66067*w+0.038*w, top: 0.80335*w+0.038*w},{ duration: 250, queue: false });
          $( "#smartbox55" ).animate({left: 0.66067*w+0.018*w, top: 0.96402*w+0.018*w},{ duration: 250, queue: false });

          $( "#smartbox6" ).animate({left: 0.82134*w+0.018*w, top: 0.16067*w+0.018*w},{ duration: 250, queue: false });
          $( "#smartbox16" ).animate({left: 0.82134*w+0.018*w, top: 0.32134*w+0.018*w},{ duration: 250, queue: false });
          $( "#smartbox26" ).animate({left: 0.821347*w+0.018*w, top: 0.48201*w+0.018*w},{ duration: 250, queue: false });
          $( "#smartbox36" ).animate({left: 0.82134*w+0.012*w, top: 0.64268*w+0.012*w},{ duration: 250, queue: false });
          $( "#smartbox46" ).animate({left: 0.82134*w+0.018*w, top: 0.80335*w+0.018*w},{ duration: 250, queue: false });
          $( "#smartbox56" ).animate({left: 0.82134*w+0.012*w, top: 0.96402*w+0.012*w},250, function() { wrapup();});
